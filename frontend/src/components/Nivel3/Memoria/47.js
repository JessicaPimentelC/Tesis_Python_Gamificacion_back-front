...
const CuarentaSieteNivel3 = () => {
  ...
  const cards = [
    { id: 1, value: "in", pairId: 1 },
    { id: 2, value: "==", pairId: 2 },
    { id: 3, value: "in", pairId: 1 },
    { id: 4, value: "!=", pairId: 3 },
    { id: 5, value: "in", pairId: 1 },
    { id: 6, value: "and", pairId: 4 },
  ];
  ...
  const handleVerify = () => {
    const correctPairs = matchedPairs.filter((id) =>
      cards.find((card) => card.id === id && card.value === "in")
    );
          ...
          <div className="white-background">
            ...
            <div className="nivel1-card">
              <div className="nivel1-card-header">
                <span>EJERCICIO RECORRER UNA PALABRA</span>
              </div>
              <div className="nivel1-card-body-ejer1">
                <p>
                  Encuentra la palabra clave correcta para completar el código.
                </p>
                <div className="code-box">
                  ...
                  <div className="code">
                    <pre>
                      palabra = "Python"{"\n"}
                      for letra <span className="highlight">____</span> palabra:
                      {"\n"}
                      {"    "}print(letra)
                    </pre>
                  </div>
                ...
                <div className="verify-container">
                  {isCorrect === true && (
                    <p className="result correct">
                      ¡Correcto! La palabra clave es "in".
                    </p>
                  )}
                  {isCorrect === false && (
...
export default CuarentaSieteNivel3;
