...
const CuarentaDosNivel3 = () => {
 ...
 //Permite avanzar entre ejercicios
  ...
  const cards = [
    { id: 1, value: "while", pairId: 1 },
    { id: 2, value: "for", pairId: 3 },
    { id: 3, value: "while", pairId: 1 },
    { id: 4, value: "if", pairId: 7 },
    { id: 5, value: "else", pairId: 8 },
    { id: 6, value: "else", pairId: 4 },
  ];
    ...
    if (flippedCards.length === 1) {
      ...
      if (firstCard.pairId === card.pairId) {
        ...
        const printCardsMatched = cards.filter(c => 
          c.value === "while" && newMatchedPairs.includes(c.id)
        ).length === 2; 
          ...
          <div className="white-background">
            ...
            <div className="nivel1-card">
              <div className="nivel1-card-header">
                <span>EJERCICIO SECUENCIA DE FIBONACCI</span>
              </div>
              <div className="nivel1-card-body">
                <p>Selecciona la palabra clave correcta para completar el código.</p>
                <div className="code-box">
                  ...
                  <div className="code">
                    <pre>
                      a, b = 0, 1{"\n"}
                      contador = 1{"\n"}
                      <span className="highlight">____</span> contador &lt;= 10:{"\n"}
                      &nbsp;&nbsp;&nbsp;&nbsp;print(a, end=" "){"\n"}
                      &nbsp;&nbsp;&nbsp;&nbsp;a, b = b, a + b{"\n"}
                      &nbsp;&nbsp;&nbsp;&nbsp;contador += 1{"\n"}
                    </pre>
...
export default CuarentaDosNivel3;
