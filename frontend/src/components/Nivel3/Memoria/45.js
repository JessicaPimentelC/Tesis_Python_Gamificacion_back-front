          ...
          <div className="white-background">
            ...
            <div className="nivel1-card">
              <div className="nivel1-card-header">
                <span>EJERCICIO MULTIPLICACIÓN MANUAL</span>
              </div>
                ...
                <div className="code-box">
                  ...
                  <div className="code">
                    <pre>
                      ...
                      i = 0{"\n"}
                      while i &lt; b:{"\n"}
                      {'    '}resultado <span className="highlight">____</span> a{"\n"}
                      {'    '}i += 1{"\n"}
...
export default CuarentaCuatroNivel3;
