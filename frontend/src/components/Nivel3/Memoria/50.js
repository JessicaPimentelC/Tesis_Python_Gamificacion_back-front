...
const CincuentaNivel3 = () => {
  ...
  const handleNext = async () => {
    ...
    const cards = [
      { id: 1, value: "for", pairId: 1 },
      { id: 2, value: "while", pairId: 2 },
      { id: 3, value: "for", pairId: 1 },
      { id: 4, value: "if", pairId: 3 },
      { id: 5, value: "if", pairId: 5 },
      { id: 6, value: "while", pairId: 4 },
    ];
      ...
      if (flippedCards.length === 1) {
        ...
        if (firstCard.pairId === card.pairId) {
          ...
          const printCardsMatched = cards.filter(c => 
            c.value === "for" && newMatchedPairs.includes(c.id)
          ).length === 2; 
          ...
          <div className="white-background">
            ...
            <div className="nivel1-card">
              <div className="nivel1-card-header">
                <span>EJERCICIO ESTRUCTURA DE CONTROL FOR</span>
              </div>
              <div className="nivel1-card-body">
                ...
                <div className="code-box">
                  ...
                  <div className="code">
                    <pre>
                      ...
                      <span className="highlight">____</span> color in colores:{"\n"}
                      {'    '}print(color)
                    </pre>
                  </div>
                </div>
                ...
                <div className="verify-container">
                  {isCorrect === true && (
                    <p className="result correct">¡Correcto! La palabra clave es "for".</p>
                  )}
...
export default CincuentaNivel3;
