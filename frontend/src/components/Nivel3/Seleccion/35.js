          ...
          <div className="white-background">
            ...
            <div className="nivel1-card">
              <div className="nivel1-card-header">
                <h2>EJERCICIO 35 - SUMA DE NÚMEROS</h2>
              </div>
                ...
                <div className="code-box">
                  ...
                  <div className="code-content">
                    <pre>
                      {`suma = 0
while True:
    numero = _____(input("Ingresa un número (0 para terminar): "))
    if numero == 0:
        break
    suma += numero
print(f"La suma de los números ingresados es: {suma}")`}
                ...
                <div className="options">
                  {["int", "float", "str", "while"].map((option) => (
                    <div
                      key={option}
...
export default Nivel3TreintaCinco;
