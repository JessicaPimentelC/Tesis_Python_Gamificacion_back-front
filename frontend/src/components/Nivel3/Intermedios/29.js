          ...
          <div className="white-background">
            ...
            <div className="nivel1-card">
              <div className="nivel1-card-header">
                <h2>EJERCICIO 29 - TABLA DE MULTIPLICAR</h2>
              </div>
              ...
              <div className="nivel1-card-body">
                <div className="code-box">
                  ...
                  <pre>
                    ...
                    />
                    {`(input("Ingresa un número para ver su tabla de multiplicar: ")) 
for i in range(1, 11): 
    resultado = numero * i 
...
export default Nivel3Veintinueve;
