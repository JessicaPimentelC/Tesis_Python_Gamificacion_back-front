          ...
          <div className="white-background">
            ...
            <div className="nivel1-card">
              ...
              <div className="nivel1-card-body">
                <p>
                  Completa el código arrastrando la palabra clave correcta para solicitar números hasta que el usuario ingrese 0.
                </p>
