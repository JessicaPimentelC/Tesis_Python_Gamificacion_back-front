          ...
          <div className="white-background">
            ...
            <div className="nivel1-card">
              ...
              <div className="nivel1-card-body">
                <p>
                  Completa el código arrastrando la estructura de control correcta para repetir la entrada hasta que se ingrese una frase con menos de 3 caracteres.
                </p>
