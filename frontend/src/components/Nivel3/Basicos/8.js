...
const OchoNivel3 = () => {
  ...
  const handleVerify = async () => {
    ...
    const isCorrectAnswer = droppedItem === "i";
    setIsCorrect(isCorrectAnswer);

      try {
        const ejercicio_id = 108; 
          ...
          <div className="white-background">
            ...
            <div className="nivel1-card">
              ...
              <div className="nivel1-card-body">
                <p>
                  Completa el código arrastrando la variable correcta para imprimir los 20 primeros números impares.
                </p>
                ...
                <div
                  ...
                  onDrop={handleDrop}
                >
                  {droppedItem ? `Variable seleccionada: ${droppedItem}` : "Arrastra aquí la variable correcta"}
                </div>
