...
//obtiene el id del ejercicio
  ...
  const options = ["console", "print", "input"];
  ...
  const handleVerify = async () => {
    ...
    const isCorrectAnswer = droppedItem === "input";
    setIsCorrect(isCorrectAnswer);

      try {
        const ejercicio_id = 109; 
          ...
          <div className="white-background">
            ...
            <div className="nivel1-card">
              ...
              <div className="nivel1-card-body">
                <p>
                  Completa el código arrastrando la función correcta para recibir una palabra y mostrarla tres veces separada por espacios.
                </p>
