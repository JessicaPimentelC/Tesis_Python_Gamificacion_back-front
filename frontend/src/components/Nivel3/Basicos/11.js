...
//obtiene el id del ejercicio
  ...
  const options = ["range", "input", "print"];
          ...
          <div className="white-background">
            ...
            <div className="nivel1-card">
              ...
              <div className="nivel1-card-body">
                <p>
                  Completa el código arrastrando la función correcta para imprimir una cadena de texto n veces.
                </p>
