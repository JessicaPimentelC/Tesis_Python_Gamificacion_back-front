  ...
  return (
          ...
          <div className="white-background">
            ...
            <div className="nivel1-card">
              ...
              <div className="nivel1-card-body">
                <p>
                  Completa el código arrastrando la palabra correcta en el espacio en blanco.
                </p>
    ...
    <code>
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;______("La suma es:", suma)
                ...
                >
                  {droppedItem
                    ? `La palabra seleccionada es ${droppedItem}`
