...
const CatorceNivel3 = () => {
  ...
  const handleVerify = async () => {
    ...
    const isCorrectAnswer = droppedItem === "for";
    setIsCorrect(isCorrectAnswer);

      try {
        const ejercicio_id = 114; 
          ...
          <div className="white-background">
            ...
            <div className="nivel1-card">
              <div className="nivel1-card-header">
                <span>EJERCICIO #14</span>
              </div>
              <div className="nivel1-card-body">
                <p>
                  Completa el código arrastrando la estructura de control correcta para imprimir un número la cantidad de veces que vale.
                </p>
