        ...
        <div className="white-background">
          ...
          <div className="nivel1-card">
            <div className="nivel1-card-header">
              <span>  Conteo del 1 al 50 usando un bucle while
              </span>
            </div>
            <div className="nivel1-card-body">
              <p>
              Este programa utiliza un bucle while para imprimir los números del 1 al 50 de manera secuencial. La variable i comienza en 1 y se incrementa en cada iteración hasta alcanzar 50. Esto permite recorrer y mostrar todos los números dentro del rango especificado.</p>
