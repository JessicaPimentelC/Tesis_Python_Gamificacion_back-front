        ...
        <div className="white-background">
          ...
          <div className="nivel1-card">
            <div className="nivel1-card-header">
              <span>Repetición de una Palabra Ingresada</span>
            </div>
            <div className="nivel1-card-body">
              <p>
              Este programa solicita al usuario que ingrese una palabra y luego la imprime tres veces, separada por espacios. Para ello, utiliza la operación de multiplicación de cadenas en Python: (palabra + " ") * 3, que concatena la palabra con un espacio y la repite tres veces.
              </p>
...
`} </code>
              ...
              {showGif && (
                <div className="gif-container">
                  <img src="/GifNivel3/9.gif" alt="GIF" className="gif-image" />
                </div>
              )}
