        ...
        <div className="white-background">
          ...
          <div className="nivel1-card">
            <div className="nivel1-card-header">
              <span>Impresión de un Patrón Numérico Descendente</span>
            </div>
            <div className="nivel1-card-body">
              <p>
              Este programa imprime un patrón numérico en el que cada fila comienza con un número que decrece en cada línea. Se usa un bucle for anidado.</p>
...
`} </code>
              ...
              {showGif && (
                <div className="gif-container">
                  <img src="/GifNivel3/25.gif" alt="GIF" className="gif-image" />
                </div>
              )}
      ...
      {showModal && (
        <div className="modal-overlay">
          <div className="modal-content">
            ...
            <img src="/e.gif" alt="GIF de bienvenida" className="modal-gif" />
