        ...
        <div className="white-background">
          ...
          <div className="nivel1-card">
            <div className="nivel1-card-header">
              <span> Contar la cantidad de dígitos de un número
              </span>
            </div>
            <div className="nivel1-card-body">
              <p>
              Este programa calcula cuántos dígitos tiene un número entero utilizando un bucle while. En cada iteración, divide el número entre 10 para eliminar el último dígito y aumenta un contador hasta que el número se reduzca a 0. Finalmente, muestra la cantidad total de dígitos.</p>
