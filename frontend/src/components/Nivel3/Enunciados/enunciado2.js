        ...
        <div className="white-background">
          ...
          <div className="nivel1-card">
            <div className="nivel1-card-header">
              <span> Cálculo de la Suma de los Primeros 100 Números Naturales</span>
            </div>
            <div className="nivel1-card-body">
              <p>
              Este código utiliza un bucle for en Python para calcular la suma de los primeros 100 números naturales. La variable suma comienza en 0 y, en cada iteración, se le suma el valor de i, que va desde 1 hasta 100.l 50 (el 51 no se incluye).
              </p>
...
export default Enunciado2Nivel3;
