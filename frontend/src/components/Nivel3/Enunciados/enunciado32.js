        ...
        <div className="white-background">
          ...
          <div className="nivel1-card">
            <div className="nivel1-card-header">
              <span> Suma de los números del 1 al 100
              </span>
            </div>
            <div className="nivel1-card-body">
              <p>
              Este programa calcula la suma de todos los números del 1 al 100 utilizando un bucle for. A medida que el bucle recorre cada número en el rango, estos se van sumando en la variable suma. Al finalizar el ciclo, el programa muestra el resultado total de la suma, proporcionando una forma eficiente de calcular la sumatoria de una secuencia de números consecutivos.
</p>
