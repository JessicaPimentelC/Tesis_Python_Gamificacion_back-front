...
const Enunciado29Nivel3 = () => {
  ...
  const handleCloseModal = () => {
    setShowModal(false);
    navigate('/Nivel3/intermedios/29');
  };
        ...
        <div className="white-background">
          ...
          <div className="nivel1-card">
            <div className="nivel1-card-header">
              <span> Generador de Tablas de Multiplicar
              </span>
            </div>
            <div className="nivel1-card-body">
              <p>
              Este programa solicita al usuario que ingrese un número y muestra su tabla de multiplicar desde el 1 hasta el 10.</p>
...
export default Enunciado29Nivel3;
