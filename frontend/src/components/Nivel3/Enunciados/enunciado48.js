        ...
        <div className="white-background">
          ...
          <div className="nivel1-card">
            ...
            <div className="nivel1-card-body">
              <p>
              Este programa imprime una cuenta regresiva desde 10 hasta 1 utilizando un bucle while. En cada iteración, el valor de i se reduce en 1 hasta que alcanza 0, momento en el que el ciclo finaliza.</p>
