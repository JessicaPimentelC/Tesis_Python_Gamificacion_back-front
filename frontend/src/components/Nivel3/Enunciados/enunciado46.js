        ...
        <div className="white-background">
          ...
          <div className="nivel1-card">
            ...
            <div className="nivel1-card-body">
              <p>
              Este programa cuenta cuántos números entre 1 y 100 son divisibles por 7. Utiliza un bucle while que recorre los números del 1 al 100 y un contador que se incrementa cada vez que un número es múltiplo de 7. Al finalizar, muestra la cantidad total de números divisibles por 7 en el rango especificado.</p>
