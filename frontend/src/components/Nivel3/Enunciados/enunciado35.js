        ...
        <div className="white-background">
          ...
          <div className="nivel1-card">
            <div className="nivel1-card-header">
              <span>  Suma de números ingresados hasta ingresar 0
              </span>
            </div>
            <div className="nivel1-card-body">
              <p>
              Este programa permite al usuario ingresar números de forma repetida y los va sumando en una variable acumuladora llamada suma. Utiliza un bucle while True, que continuará ejecutándose hasta que el usuario ingrese el número 0, momento en el cual el programa se detiene y muestra el resultado total de la suma. Esta estructura es útil cuando no se sabe de antemano cuántos números se ingresarán.</p>
