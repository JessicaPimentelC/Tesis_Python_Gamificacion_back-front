        ...
        <div className="white-background">
          ...
          <div className="nivel1-card">
            <div className="nivel1-card-header">
              <span>Uso del Bucle for para Generar una Secuencia Numérica</span>
            </div>
            <div className="nivel1-card-body">
              <p>
              Este código utiliza un bucle for en Python para recorrer e imprimir los números del 1 al 50 de forma secuencial. La función range(1, 51) genera un rango de números desde el 1 hasta el 50 (el 51 no se incluye).
              </p>
...
export default Enunciado1Nivel3;
