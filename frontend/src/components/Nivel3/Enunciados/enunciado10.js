        ...
        <div className="white-background">
          ...
          <div className="nivel1-card">
            <div className="nivel1-card-header">
              <span>Creación de un Triángulo con Asteriscos</span>
            </div>
            <div className="nivel1-card-body">
              <p>
              Este programa solicita al usuario un número de filas y luego utiliza un bucle for para dibujar un triángulo con asteriscos. En cada iteración, se imprime una cantidad de * equivalente al número de fila actual, generando así la forma del triángulo.
              </p>
...
export default Enunciado10Nivel3;
