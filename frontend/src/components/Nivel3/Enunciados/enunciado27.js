...
const Enunciado27Nivel3 = () => {
  ...
  const handleCloseModal = () => {
    setShowModal(false);
    navigate('/Nivel3/intermedios/27');
  };
        ...
        <div className="white-background">
          ...
          <div className="nivel1-card">
            <div className="nivel1-card-header">
              <span> Contador de Caracteres en una Cadena</span>
            </div>
            <div className="nivel1-card-body">
              <p>
              Este programa solicita al usuario que ingrese una cadena de texto y un carácter específico. Luego, recorre la cadena y cuenta cuántas veces aparece dicho carácter. Finalmente, muestra el resultado en pantalla.</p>
...
for caracter in cadena:
    if caracter == caracterBuscado:
        contador += 1
print("El carácter",caracterBuscado," aparece ",contador,"veces en la cadena.")
...
export default Enunciado27Nivel3;
