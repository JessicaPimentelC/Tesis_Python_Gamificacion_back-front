        ...
        <div className="white-background">
          ...
          <div className="nivel1-card">
            ...
            <div className="nivel1-card-body">
              <p>
              Este programa solicita al usuario que ingrese un número entero positivo y luego calcula la suma de sus dígitos. Para ello, extrae cada dígito utilizando el operador módulo (%), lo suma a una variable acumuladora (suma), y luego elimina el dígito dividiendo el número entre 10 (//).</p>
