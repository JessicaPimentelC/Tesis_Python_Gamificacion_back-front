        ...
        <div className="white-background">
          ...
          <div className="nivel1-card">
            <div className="nivel1-card-header">
              <span> Sumar los dígitos de un número
              </span>
            </div>
            <div className="nivel1-card-body">
              <p>
              Este programa calcula la suma de los dígitos de un número entero. Utiliza un bucle while que extrae el último dígito del número con el operador módulo (%), lo suma a una variable acumuladora y luego elimina ese dígito dividiendo el número por 10. El proceso se repite hasta que el número se reduzca a 0, mostrando al final la suma total de sus dígitos.</p>
