        ...
        <div className="white-background">
          ...
          <div className="nivel1-card">
            <div className="nivel1-card-header">
              <span> Impresión de caracteres de una palabra
              </span>
            </div>
            <div className="nivel1-card-body">
              <p>
              Este programa toma una palabra predefinida, en este caso "Python", y muestra cada una de sus letras en una línea diferente. Utiliza un bucle for para recorrer la cadena de texto y mostrar cada carácter por separado.</p>
