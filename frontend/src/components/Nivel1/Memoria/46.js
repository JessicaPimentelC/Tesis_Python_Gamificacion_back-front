...
//Permite avanzar entre ejercicios
  ...
  const cards = [
    { id: 1, value: "import", pairId: 1 },
    { id: 2, value: "import", pairId: 2 },
    { id: 3, value: "horas", pairId: 3 },
    { id: 4, value: "if", pairId: 1 },
    { id: 5, value: "if", pairId: 2 },
    { id: 6, value: "horas", pairId: 3 }, // Par para el "="
  ];
            ...
            <div className="nivel1-card">
              ...
              <div className="nivel1-card-body">
                ...
                <div className="verify-container">
                  {isCorrect === true && (
                    <p className="result correct">¡Correcto! El signo es "horas"</p>
                  )}
                  {isCorrect === false && (
