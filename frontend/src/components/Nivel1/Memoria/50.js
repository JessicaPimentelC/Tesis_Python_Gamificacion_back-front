...
//Permite avanzar entre ejercicios
  ...
  const cards = [
    ...
    { id: 2, value: "import", pairId: 3 },
    { id: 3, value: "if", pairId: 1 },
    { id: 4, value: "elif", pairId: 2 },
    { id: 5, value: "if", pairId: 2 },
    { id: 6, value: "import", pairId: 3 }, // Par para el "="
  ];
          ...
          <div className="white-background">
            ...
            <div className="nivel1-card">
              <div className="nivel1-card-header">
                <span>Cálculo del Volumen de un Cilindro en Python
              ...
              <div className="nivel1-card-body">
                ...
                <div className="verify-container">
                  {isCorrect === true && (
                    <p className="result correct">¡Correcto! El signo es "import"</p>
                  )}
                  {isCorrect === false && (
...
export default Cuarentacincuenta;
