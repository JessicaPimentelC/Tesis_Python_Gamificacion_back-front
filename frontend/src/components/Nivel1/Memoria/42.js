...
//Permite avanzar entre ejercicios
  ...
  const cards = [
    { id: 1, value: "fecha", pairId: 3 },
    { id: 2, value: "input", pairId: 2 },
    { id: 3, value: "fecha", pairId: 3 },
    { id: 4, value: "input", pairId: 1 },
            ...
            <div className="nivel1-card">
              ...
              <div className="nivel1-card-body">
                  ...
                  <div className="code">
                    <pre>
                      <code>
                        ...
                        print("Tu fecha de nacimiento es:”,______){"\n"}
                ...
                <div className="verify-container">
                  {isCorrect === true && (
                    <p className="result correct">¡Correcto! El signo es "fecha"</p>
                  )}
                  {isCorrect === false && (
