...
//Permite avanzar entre ejercicios
  ...
  const cards = [
    ...
    { id: 2, value: "float", pairId: 3 },
    { id: 3, value: "float", pairId: 3 },
    { id: 4, value: "for", pairId: 2 },
            ...
            <div className="nivel1-card">
              ...
              <div className="nivel1-card-body">
                ...
                <div className="verify-container">
                  {isCorrect === true && (
                    <p className="result correct">¡Correcto! El signo es "float"</p>
                  )}
                  {isCorrect === false && (
