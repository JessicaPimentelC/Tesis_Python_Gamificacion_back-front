...
const Enunciado36 = () => {
  ...
  <span>Intercambiar los valores de dos variables
...
<div className="nivel1-card-body">
  <p>
  En Python, se crea un programa que solicite dos valores al usuario y luego intercambie sus valores, mostrando el resultado en pantalla.
</p>
...
`}
              ...
              {showGif && (
                <div className="gif-container">
                  <img src="36.gif" alt="GIF" className="gif-image" />
                </div>
              )}
      ...
      {showModal && (
        <div className="modal-overlay">
          <div className="modal-content">
            ...
            <img src="8.gif" alt="GIF de bienvenida" className="modal-gif" />
