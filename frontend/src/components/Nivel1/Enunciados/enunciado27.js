...
const Enunciado27 = () => {
  ...
  <span>Cálculo de la Potencia al Cuadrado</span>
</div>
<div className="nivel1-card-body">
  <p>
    En Python, podemos calcular la potencia de un número de manera sencilla. En esta actividad, crearás un
    algoritmo que le permita al usuario ingresar un número y calcular su potencia al cuadrado.
  </p>
