...
const Enunciado29 = () => {
  ...
  <span> Cálculo del promedio de dos números ingresados por el usuario</span>
</div>
<div className="nivel1-card-body">
  <p>
  En Python, se puede crear un algoritmo para que el usuario ingrese dos números y luego ver en pantalla el promedio de ambos.
</p>
...
`}
              ...
              {showGif && (
                <div className="gif-container">
                  <img src="29.gif" alt="GIF" className="gif-image" />
                </div>
              )}
      ...
      {showModal && (
        <div className="modal-overlay">
          <div className="modal-content">
            ...
            <img src="1.gif" alt="GIF de bienvenida" className="modal-gif" />
