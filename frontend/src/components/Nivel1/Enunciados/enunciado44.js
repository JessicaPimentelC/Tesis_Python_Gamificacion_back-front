        ...
        <div className="white-background">
          ...
          <div className="nivel1-card">
            <div className="nivel1-card-header">
              <span>Cálculo de la División entre Dos Números en Python

</span>
            </div>
            <div className="nivel1-card-body">
              <p>
              En Python, se puede crear un algoritmo que permita al usuario ingresar dos números y calcular el resultado de su división. 
              </p>
