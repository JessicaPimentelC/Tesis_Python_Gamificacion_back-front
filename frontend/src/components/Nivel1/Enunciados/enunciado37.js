...
const Enunciado37 = () => {
  ...
  <span>Cálculo del Perímetro de un Círculo en Python
...
<div className="nivel1-card-body">
  <p>
  En Python, se puede crear fácilmente un algoritmo que calcule el perímetro de un círculo solicitando al usuario el valor del radio. Utiliza la fórmula:
</p>
...
print("El perímetro del círculo es:", perimetro)
              ...
              {showGif && (
                <div className="gif-container">
                  <img src="37.gif" alt="GIF" className="gif-image" />
                </div>
              )}
      ...
      {showModal && (
        <div className="modal-overlay">
          <div className="modal-content">
            ...
            <img src="9.gif" alt="GIF de bienvenida" className="modal-gif" />
