...
<div className="nivel1-card-body">
  <p>
  En Python, se puede crear un algoritmo que almacene el texto "Hola Mundo" en una variable y un número en otra variable. Luego, muestra en pantalla el contenido de ambas variables juntas.
...
print(variable1,variable2)
              ...
              {showGif && (
                <div className="gif-container">
                  <img src="30.gif" alt="GIF" className="gif-image" />
                </div>
              )}
      ...
      {showModal && (
        <div className="modal-overlay">
          <div className="modal-content">
            ...
            <img src="2.gif" alt="GIF de bienvenida" className="modal-gif" />
