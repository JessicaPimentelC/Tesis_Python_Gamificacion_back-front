...
const Treintasiete = () => {
  // Estado para manejar las opciones disponibles, con la opción "import" incluida
          ...
          <div className="white-background">
            ...
            <div className="nivel1-card">
              <div className="nivel1-card-header">
                <span>Ejercicio de import</span>
              </div>
              <div className="nivel1-card-body">
                <p>
                  En este ejercicio, debes seleccionar la palabra clave al inicio para poder utilizar el módulo `math`.
                </p>
                ...
                <div className="options">
                  {["print", "import", "float", "math"].map((option) => (
                    <div
                      key={option}
