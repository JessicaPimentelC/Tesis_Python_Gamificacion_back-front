...
//Permite avanzar entre ejercicios
  ...
  const cards = [
    { id: 1, value: "print", pairId: 3 }, // Respuesta correcta
    { id: 2, value: "sum", pairId: 2 },
    { id: 3, value: "len", pairId: 1 },
    { id: 4, value: "sum", pairId: 4 },
    { id: 5, value: "print", pairId: 3 }, // Segunda opción correcta
    { id: 6, value: "len", pairId: 5 },
  ];
    ...
    if (flippedCards.length === 1) {
      ...
      if (firstCard.pairId === card.pairId) {
        ...
        const printCardsMatched = cards.filter(c => 
          c.value === "print" && newMatchedPairs.includes(c.id)
                ...
                <div className="code-box">
                  ...
                  <div className="code">
                    <pre>
                      ...
                      if suma == int(numero):{"\n"}
                      &nbsp;&nbsp;&nbsp;&nbsp;______("Es un número de Armstrong"){"\n"}
                      else:{"\n"}
                      &nbsp;&nbsp;&nbsp;&nbsp;______("No es un número de Armstrong"){"\n"}
                    </pre>
                  </div>
                </div>
