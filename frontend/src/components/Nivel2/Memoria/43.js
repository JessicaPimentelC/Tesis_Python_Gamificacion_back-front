...
const CuarentaTresNivel2= () => {
  ...
  const cards = [
    { id: 1, value: '"else"', pairId: 1 },
    { id: 2, value: '"if"', pairId: 2 }, // Respuesta correcta
    { id: 3, value: '"Es un triángulo equilátero."', pairId: 3 },
    { id: 4, value: '"if"', pairId: 2 }, // Otra opción correcta
    { id: 5, value: '"else"', pairId: 1 },
    { id: 6, value: '"Es un triángulo equilátero."', pairId: 3 },
];
  ...
  const handleVerify = () => {
    const correctPairs = matchedPairs.filter((id) =>
      cards.find((card) => card.id === id && card.value === '"if"')
    );
            ...
            <div className="nivel1-card">
              ...
              <div className="nivel1-card-body-ejer1">
                ...
                <div className="verify-container">
                  {isCorrect === true && (
                    <p className="result correct">¡Correcto! El triángulo es escaleno.</p>
                  )}
