        ...
        <div className="white-background">
          ...
          <div className="nivel1-card">
            <div className="nivel1-card-header">
              <span>🕒 Asignación de Turnos según la Hora en Python

</span>
            </div>
            <div className="nivel1-card-body">
            <p>
            El programa pedirá al usuario que ingrese una hora en formato de 24 horas (de 0 a 23) y determinará a qué turno pertenece. Si la hora está entre 6 y 11, se clasificará como "Turno de la mañana"; entre 12 y 17, será "Turno de la tarde"; y entre 18 y 23 o de 0 a 5, se considerará "Turno de la noche".
            </p>
