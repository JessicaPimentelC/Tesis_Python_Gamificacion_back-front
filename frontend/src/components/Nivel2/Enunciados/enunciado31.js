        ...
        <div className="white-background">
          ...
          <div className="nivel1-card">
            <div className="nivel1-card-header">
              <span> 🎯 Clasificación por Rango de Edad en Python
...
`} </code>
              ...
              {showGif && (
                <div className="gif-container">
                  <img src="/GifNivel2/31.gif" alt="GIF" className="gif-image" />
                </div>
              )}
...
export default Enunciado31Nivel2;
