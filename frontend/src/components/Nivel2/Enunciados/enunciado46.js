        ...
        <div className="white-background">
          ...
          <div className="nivel1-card">
            <div className="nivel1-card-header">
              <span> 🎯 ¿Está tu número en el rango correcto? ¡Averígualo!

</span>
            </div>
            <div className="nivel1-card-body">
            <p>
            Este programa te permitirá comprobar si un número está dentro del rango de 10 a 20. 🧐</p>
...
`} </code>
              ...
              {showGif && (
                <div className="gif-container">
                  <img src="/GifNivel2/46.gif" alt="GIF" className="gif-image" />
                </div>
              )}
...
export default Enunciado46Nivel2;
