        ...
        <div className="white-background">
          ...
          <div className="nivel1-card">
            <div className="nivel1-card-header">
              <span> 🔍 Verificador de Números: ¿Es Positivo y Mayor que 100?
</span>
            </div>
...
`} </code>
              ...
              {showGif && (
                <div className="gif-container">
                  <img src="/GifNivel2/47.gif" alt="GIF" className="gif-image" />
                </div>
              )}
...
export default Enunciado47Nivel2;
