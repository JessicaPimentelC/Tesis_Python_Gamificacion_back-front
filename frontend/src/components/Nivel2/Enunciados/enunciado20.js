        ...
        <div className="white-background">
          ...
          <div className="nivel1-card">
            <div className="nivel1-card-header">
              <span> 🔢 Determinación del Número Mayor en Python
            ...
            <p>
            El programa solicitará al usuario que ingrese tres números y determinará cuál de ellos es el mayor. Luego, mostrará el resultado en pantalla.      </p>
