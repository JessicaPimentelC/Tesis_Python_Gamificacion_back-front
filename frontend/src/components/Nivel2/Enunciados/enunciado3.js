        ...
        <div className="white-background">
          ...
          <div className="nivel1-card">
            <div className="nivel1-card-header">
              <span>¿CÓMO FUNCIONA EL CONDICIONAL ELSE EN PYTHON?</span>
            </div>
            <div className="nivel1-card-body">
              <p>
              Se utiliza para especificar un bloque de código que debe ejecutarse si no se cumple ninguna de las condiciones de las sentencias if y elif anteriores.
              </p>
...
`} </code>
              ...
              {showGif && (
                <div className="gif-container">
                  <img src="/GifNivel2/3.gif" alt="GIF" className="gif-image" />
                </div>
              )}
      ...
      {showModal && (
        <div className="modal-overlay">
          <div className="modal-content">
            ...
            <img src="/nivel222.gif" alt="GIF de bienvenida" className="modal-gif" />
...
export default Enunciado3Nivel2;
