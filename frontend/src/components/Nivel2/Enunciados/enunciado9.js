...
`} </code>
              ...
              {showGif && (
                <div className="gif-container">
                  <img src="/GifNivel2/9.gif" alt="GIF" className="gif-image" />
                </div>
              )}
      ...
      {showModal && (
        <div className="modal-overlay">
          <div className="modal-content">
            ...
            <img src="/nivel333..gif" alt="GIF de bienvenida" className="modal-gif" />
...
export default Enunciado9Nivel2;
