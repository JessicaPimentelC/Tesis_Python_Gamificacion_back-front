        ...
        <div className="white-background">
          ...
          <div className="nivel1-card">
            <div className="nivel1-card-header">
              <span> ⚡ ¿El número es negativo o menor que -50? ¡Descúbrelo!
</span>
            </div>
...
`} </code>
              ...
              {showGif && (
                <div className="gif-container">
                  <img src="/GifNivel2/48.gif" alt="GIF" className="gif-image" />
                </div>
              )}
...
export default Enunciado48Nivel2;
