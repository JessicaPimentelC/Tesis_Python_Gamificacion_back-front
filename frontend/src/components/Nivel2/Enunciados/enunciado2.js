        ...
        <div className="white-background">
          ...
          <div className="nivel1-card">
            <div className="nivel1-card-header">
              <span>¿CÓMO FUNCIONA EL CONDICIONAL ELIF EN PYTHON?</span>
            </div>
            <div className="nivel1-card-body">
              <p>
              El condicional elif en Python se utiliza para especificar condiciones adicionales que probar después de la sentencia if inicial.
              </p>
