...
const Enunciado29Nivel2 = () => {
  ...
  const handleCloseModal = () => {
    setShowModal(false);
    navigate('/Nivel2/intermedios/29');
  };
        ...
        <div className="white-background">
          ...
          <div className="nivel1-card">
            <div className="nivel1-card-header">
              <span> 🔢 Verificación de Número Positivo y Par en Python
...
`} </code>
              ...
              {showGif && (
                <div className="gif-container">
                  <img src="/GifNivel2/29.gif" alt="GIF" className="gif-image" />
                </div>
              )}
...
export default Enunciado29Nivel2;
