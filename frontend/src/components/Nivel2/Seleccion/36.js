...
//Permite avanzar entre ejercicios
  ...
  const checkAnswer = () => {
    if (selectedAnswer === "math.isqrt") {
      setOutput("¡Correcto! La función 'math.isqrt' es la correcta.");
      setScore(score + 10);
      setShowNext(true);
    } else {
...
const handleVerify = async (answer) => {
  ...
  const isCorrect = answer === "math.isqrt";  
  setOutput("¡Correcto! La función 'math.isqrt' es la correcta.");
          ...
          <div className="white-background">
            ...
            <div className="nivel1-card">
              <div className="nivel1-card-body">
                <span>Ejercicio de Cuadrado Perfecto</span>
                ...
                <div className="options">
                  {["math.sqrt", "math.isqrt", "math.pow", "math.ceil"].map((option) => (
                    <div
                      key={option}
...
export default Nivel2Treintacuatro;
