...
import { redirigirAEnunciado,obtenerEjercicioAleatorioEnunciado } from '../../../utils/utils';
import Swal from "sweetalert2";
import API_BASE_URL from "../../../config";
import axios from "axios";

const Nivel2Veintiocho = () => {
...
const handleNext = async () => {
  ...
  const checkAnswer = () => {
    if (respuesta.trim().toLowerCase() === 'print') {
      setOutput('¡Correcto! La palabra clave print es la correcta.');
      setScore(score + 10);
    } else {
            ...
            <div className="nivel1-card">
              ...
              <div className="nivel1-card-body">
                <div className="code-box">
                  ...
                  <div className="code">
                    <pre>
                      letra = input("Ingresa una letra: ").lower() <br />
                      <br />
                      if letra in ['a', 'e', 'i', 'o', 'u']: <br />
                      &nbsp;&nbsp;&nbsp;&nbsp;
                      <input
                        type="text"
                        value={respuesta}
...
export default Nivel2Veintiocho;
