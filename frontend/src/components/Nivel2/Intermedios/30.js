                ...
                <div className="code-box">
                  ...
                  <div className="code">
                    <pre>
                      ...
                      <br />
                      if numero % 4 == 0 and numero % 6 != 0: <br />
                      &nbsp;&nbsp;&nbsp;&nbsp;print("El número es divisible por 4 pero no por 6.") <br />
                      else: <br />
                      &nbsp;&nbsp;&nbsp;&nbsp;print("El número no cumple la condición.") <br />
                    </pre>
                  </div>
                </div>
