...
const CuatroNivel2 = () => {
  ...
  return (
        ...
        <div className="white-background">
          ...
          <div className="nivel1-card">
            ...
            <div className="nivel1-card-body">
              <p>Complete los espacios en blanco con el codigo y la sintaxis correcta</p>
            </div>
            <div className="nivel1-card-body">
    ...
    print("El precio con descuento es:",precioDescuento)`} </code>
{"\n"}
    <input
                      type="text"
                      value={inputValue2}
                    ...
                    />:
                    <code>{`
    print("No aplica el descuento:", precio)`} </code>
