...
const CincoNivel2 = () => {
  ...
  const handleVerify = async (answer) => {
    ...
    const isCorrectAnswer = answer === "if";
    if (isCorrectAnswer) {
          ...
          <div className="white-background">
            ...
            <div className="nivel1-card">
              ...
              <div className="nivel1-card-body">
                <p>
                  <br />
                  Selecciona la opción correcta al espacio en blanco _______ en el siguiente código:
                                  </p>
